...
export const todayEvents = [
  ...
  { time: '10:00', title: 'Proyectos de sistemas básicos del vehículo', location: 'C-13', color: 'orange' },
  { time: '11:00', title: 'Proyectos de sistemas eléctricos', location: 'C-14', color: 'orange' },
  { time: '11:00', title: 'Proyectos de sistemas auxiliares del motor', location: 'C-15', color: 'orange' },
  { time: '13:00', title: 'Proyectos de Electricidad', location: 'C-31', color: 'navy' },
  { time: '13:00', title: 'Proyectos de Electricidad', location: 'C-32', color: 'navy' },
  { time: '14:00', title: 'Proyectos de Electricidad', location: 'C-33', color: 'navy' },
  { time: '14:00', title: 'Proyectos de Electrónica', location: 'C-36', color: 'navy' },
  { time: '14:00', title: 'Proyectos de Electrónica', location: 'C-37', color: 'navy' },
  { time: '14:00', title: 'Proyectos de Electrónica', location: 'C-38', color: 'navy' },
  { time: '15:00', title: 'Proyectos de informática', location: 'G-35', color: 'gold' },
  { time: '15:00', title: 'Proyectos de informática', location: 'G-36', color: 'gold' },
  { time: '15:00', title: 'Proyectos de informática', location: 'H-32', color: 'gold' },
  { time: '15:00', title: 'Proyectos de informática', location: 'H-33', color: 'gold' },
  { time: '15:00', title: 'Proyectos de informática', location: 'H-34', color: 'gold' },
  { time: '16:00', title: 'Proyectos de ciencias exactas', location: 'C-20', color: 'orange' },
  { time: '16:00', title: 'Proyectos de ciencias naturales', location: 'G-21', color: 'orange' },
]
