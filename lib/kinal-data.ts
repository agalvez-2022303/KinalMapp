...
export const mapPOIs: MapPOI[] = [
  ...
  { id: 'poi-ba-13', label: 'Industriales', x: 14, y: 62, type: 'checkpoint', description: 'Estampita: Industriales (M, E y EL)', checkpointId: 'CP-BA-13', lat: 14.62650, lng: -90.53562 },
...
export const albumSections: AlbumSection[] = [
  {
    ...
    stickers: [
      ...
      { id: 's13', name: 'Industriales(M, E y EL)', section: 'Básicos', sectionId: 'basicos-1', checkpointId: 'CP-BA-13', unlocked: false, emoji: '🛠️'},
